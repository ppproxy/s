...
function GetImgAddr() {
    ...
    $.ajax({
        url: 'http://file1.nmcp.cn:668/asmx/method.asmx/getImgServer',
...
//var ws_addr = "wss://wss.nmcp.cn:1001";
//var ws_addr = "wss://nmcp.cn:8007";

//var ws_addr = "ws://nmcp.cn:7007";
var ws_addr = "ws://nmcp.cn:7007";
...
$.ajax(
    {
        type: 'get',
        url: "http://file1.nmcp.cn:668/Act/WebService.asmx/getRandServer?ServerInfo=" + ServerInfo,
        async: false,  // 是否多线程异步处理
        dataType: 'json',
        cache: false,
        timeout: 5000,
...
randomOutMessge += '<img class="GG_img" alt="Deskry 匿名聊" src="http://file1.nmcp.cn:668/img/gg/gg1.png" width="200" style="position: relative;top:0px;margin-bottom:5px;cursor:pointer;display:none;" />'
...
randomOutMessgeAD += '<img class="GG_img" alt="Deskry 匿名聊" src="http://file1.nmcp.cn:668/img/gg/gg1.png" width="200" style="position: relative;top:0px;margin-bottom:5px;cursor:pointer;display:;" />'
...
$(function () {
    ...
    $("#a_uploadimg").click(function () {
        ...
        if (!randomGetIDTimeLimit()) {
            ...
            layer.msg("匹配后前30秒不允许发送图片", { time: 3000 });
        }
    ...
    $("#msg_tips").click(function () {
        if ($.cookie('isSound') == 1 || !$.cookie('isSound')) {
            ...
            $("#msg_tips").attr('src', "http://file1.nmcp.cn:668/img/sys/sound_off.png");
        }
        else {
            $.cookie('isSound', 1, { expires: 365 });
            $("#msg_tips").attr('src', "http://file1.nmcp.cn:668/img/sys/sound_on.png");
        }
    });
    ...
    $("#theme_sun_moon").click(function () {
        if ($.cookie('isMoon') == 1 || !$.cookie('isMoon')) {
            ...
            $.cookie('isMoon', -1, { expires: 365 });
            $("#theme_sun_moon").attr('src', "http://file1.nmcp.cn:668/img/sys/sun1.png");

            //$("#themeChange").attr('href', '/css/random.css?v' + Math.ceil(Math.random() * 99999))
            $("#themeChange").attr('href', 'http://file1.nmcp.cn:668/css/random.css?v=1')
            ...
            $.cookie('isMoon', 1, { expires: 365 });
            $("#theme_sun_moon").attr('src', "http://file1.nmcp.cn:668/img/sys/moon1.png");

            //$("#themeChange").attr('href', '/css/random-black.css?v' + Math.ceil(Math.random() * 99999))
            $("#themeChange").attr('href', 'http://file1.nmcp.cn:668/css/random-black.css?v=1')
        ...
        if (isUploadStyle == 0) {
            if (file.name.toLowerCase().indexOf(".gif") != -1) {
                ...
                //if (filesize > 10000) {
                    ...
                    //});
                    //layer.msg('图片大小不能超过10MB<br/>建议使用截屏后发送');
                //}
                //else {
                    imgupload_file(data);
                //}
...
$(".btn_Orders").click(function () {
    ...
    window.open("http://weixin.nmcp.cn/shop/orders.aspx");
...
$(".btn_QR_Share").click(function () {
    ...
    // 用户历史消息获取
    var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/randomVIPGetQRShareImg_My';
    var method = 'get';
    var ifAsync = true;
    ...
    $.ajax(
    {
        ...
        success: function (data) {
            ...
            if (data.code == 0) {
                ...
                NoticeStr += "<div style=text-align:center;margin-bottom:15px;><img width='200' height='auto' src='http://" + FilesCDN + ":668/" + data.msg + "'></div>";
...
function init_control() {
    ...
    if ($.cookie('isMoon') == 1) {
        ...
        $("#theme_sun_moon").attr('src', "http://file1.nmcp.cn:668/img/sys/moon1.png");
        //$("#themeChange").attr('href', 'http://file1.nmcp.cn:668/css/random-black.css?v' + Math.ceil(Math.random() * 99999))
        $("#themeChange").attr('href', 'http://file1.nmcp.cn:668/css/random-black.css')

    }
    else {

        $("#theme_sun_moon").attr('src', "http://file1.nmcp.cn:668/img/sys/sun1.png");
        //$("#themeChange").attr('href', 'http://file1.nmcp.cn:668/css/random.css?v' + Math.ceil(Math.random() * 99999))
        $("#themeChange").attr('href', 'http://file1.nmcp.cn:668/css/random.css')
...
function fun_getnickname(isauto) {
    if (!$.cookie('user_id') || !$.cookie('user_nickname_random') || !$.cookie('room_name_random') || !isauto) {
        ...
        setTimeout(function () {
            ...
            $.getJSON("http://file1.nmcp.cn:668/Act/WebService.asmx/getRandnikename", { act: "getRanNick" }, function (json) {
...
function fun_barrager_first() {
    ...
    var item = {
        img: 'http://file1.nmcp.cn:668/img/sys/logoBarragerAD.png', //图片
...
$("#user_Random").click(function () {
    ...
    var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/randomVIPGetHistoryUserList_Random';
    var method = 'post';
    var ifAsync = true;
        ...
        success: function (data) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if ($.trim(list[i].nickname) != "") {
                    htmlstr += "<a id='userid_" + list[i].id + "' class='list-group-item userList' style='color:" + color + "' onfocus='this.blur()' onclick='click_userlist(id);'>" +
                        "<img id='doheart_userid_" + list[i].id + "' onclick='DoHeartUser(id);' alt='点击收藏' src='http://file1.nmcp.cn:668/img/sys/emptyheart.png' style='position: absolute;top: 2px;left: 0px;width: 20px;margin: 8px;z-index: 1;' />" +
            ...
            if (getQueryVariable('touserid') && getQueryVariable('tousername')) {
                ...
                var htmlstr = "<a id='userid_" + getQueryVariable('touserid') + "' class='list-group-item userList' style='color:black' onfocus='this.blur()' onclick='click_userlist(id);'>" +
                            "<img id='doheart_userid_" + getQueryVariable('touserid') + "' onclick='DoHeartUser(id);' alt='点击收藏' src='http://file1.nmcp.cn:668/img/sys/emptyheart.png' style='position: absolute;top: 2px;left: 0px;width: 20px;margin: 8px;z-index: 1;' />" +
                            "<span class='badge'></span><span style='margin-right:5px;position: absolute;top: 9px;left: 28px;' class='zql-bnt-user'></span>" +
...
$("#user_My").click(function (e) {
    ...
    var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/randomVIPGetHistoryUserList_My';
    var method = 'post';
    var ifAsync = true;
    var tempdd = '{"myUserID":"' + (typeof ($.cookie('user_id')) == "undefined" ? "" : $.cookie('user_id')) + '","vipcode":"' + randomVipCode + '","serverPort":"' + ws_addr.split(':')[2] + '"}';
    var sendJsonData = $.parseJSON(tempdd);
    ...
    $.ajax(
    {
        ...
        success: function (data) {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if ($.trim(list[i].nickname) != "") {
                    htmlstr += "<a id='userid_" + list[i].id + "' class='list-group-item userList' style='color:" + color + "' onfocus='this.blur()' onclick='click_userlist(id);'>" +
                        "<img id='cancleheart_userid_" + list[i].id + "' onclick='CancleHeartUser(id);' alt='点击取消收藏' src='http://file1.nmcp.cn:668/img/sys/heart.png' style='position: absolute;top: 2px;left: 0px;width: 20px;margin: 8px;z-index: 1;' />" +
                        "<span class='badge'></span><span style='margin-right:5px;position: absolute;top: 9px;left: 28px;' class='zql-bnt-user'></span>" +
                        "<span style='margin-left: 40px;' class='nickname'>" + list[i].nickname + "<span>" +
                        "<i id='manage_userid_" + list[i].id + '_' + list[i].nickname + "' class='layui-icon layui-icon-more-vertical' style='float: right;'  onclick='ManageUser(id);'></i></a>";
...
function DoHeartUser(doheartuserid) {
    ...
    // 用户历史消息获取
    var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/random_MyHeart_Do';
    var method = 'post';
    var ifAsync = true;
...
function CancleHeartUser(doheartuserid) {
    ...
    // 用户历史消息获取
    var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/random_MyHeart_Cancle';
    var method = 'post';
    var ifAsync = true;
...
function Del_User_list(userType, warningMsg) {
    var lay_index = layer.alert(warningMsg, {
        ...
        skin: 'demo-class', btn: ['确定', '取消'], title: '', btn1: function () {
            ...
            var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/random_User_Del_All';
            var method = 'post';
            var ifAsync = true;
...
function DelUser(userid) {
    ...
    var lay_index = layer.confirm('是否删除？', {
        ...
        var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/Del_User';
        var method = 'post';
        var ifAsync = true;
        var tempdd = '{"myUserID":"' + (typeof ($.cookie('user_id')) == "undefined" ? "" : $.cookie('user_id')) + '","UserToID":"' + tuserid + '","vipcode":"' + randomVipCode + '","serverPort":"' + ws_addr.split(':')[2] + '"}';
        var sendJsonData = $.parseJSON(tempdd);
...
$("#btn_random_break").click(function () {
    ...
    if ((temp.indexOf('秒') != -1 && temp.split('秒')[0] > 3) || randomVipCode) {
        ...
        layer.msg("匹配后前3秒不允许离开<br/>vip不受此限制", { time: 3000 });
    }
...
$("#btn_input_vipcode").click(function (e) {
    ...
    $("#buy_vipcode").click(function () {
        ...
        window.open("http://weixin.nmcp.cn/shop/index.aspx");
...
$("#btn_buy_vipcode").click(function (e) {
    if (wx()) {
        ...
        window.open("http://alipay.nmcp.cn/index.aspx");
        e.stopPropagation();
    }
})
...
function random_queue_get_random(json) {
    ...
    var htmlstr = "<div id='more_fun'>" +
        "<div style='margin: 15px 5px;margin-top:33px;text-align:center;color: #DDD;'><img class='rotateImg' src='http://file1.nmcp.cn:668/img/sys/loading.png' style='position: relative; top: -1px;left:-5px;' />匹配中...</div>" +
...
function random_queue_get_random_getID(json) {
    ...
    if (ws && ws.readyState == 1 && typeof (sel_userid) != "undefined") {
        ...
        selUserInfo += '<img alt="Deskry 匿名聊" src="http://file1.nmcp.cn:668/img/sys/logo.png" width="50" style="position: relative;top:0px;margin-bottom:5px;" />'
        ...
        selUserInfo += '<div style="text-align: left; text-indent: 0em;font-size: 13px;text-align:center">' + random_SexShow + '：<span style="color:orange;">' + ((random_SexShow.indexOf("爱豆") != -1) ? (json.sel_userSex == "男" ? "女" : (json.sel_userSex == "女" ? "男" : json.sel_userSex)) : (json.sel_userSex)) + '</span></div>'
        ...
        if (!dic_userlist[sel_userid]) {
            ...
            var htmlstr = "<a id='userid_" + sel_userid + "' class='list-group-item userList' style='color:black' onfocus='this.blur()' onclick='click_userlist(id);'>" +
                        "<img id='doheart_userid_" + sel_userid + "' onclick='DoHeartUser(id);' alt='点击收藏' src='http://file1.nmcp.cn:668/img/sys/emptyheart.png' style='position: absolute;top: 2px;left: 0px;width: 20px;margin: 8px;z-index: 1;' />" +
                        "<span class='badge'></span><span style='margin-right:5px;position: absolute;top: 9px;left: 28px;' class='zql-bnt-user'></span>" +
...
function randomGetIDTimeLimit() {
    ...
    if (temp.indexOf('秒') != -1 && temp.split('秒')[0] < 30) {
        return true;
    }
    else {
        return false;
...
function fun_bindtoallmsg(json) {
    ...
    $("#old_mes_get").remove();
    $("#div_msgbox").prepend('<div id = "old_mes_get" onclick = "get_old_messge();" style="width:200px;text-align:center;margin:10px auto;color:#09c;cursor: pointer;"><img alt="查看历史消息" src="http://file1.nmcp.cn:668/img/sys/time_pic.png" width="20" style="position: relative;top:-1px;" />查看历史消息</div>');
    ...
    for (var i = 0; i < json_user.length; i++) {
        ...
        switch (code) {
            ...
            default:
                ...
                var chattitle = !self ? "<span style='color:" + color + "'>" + json_user[i].nickname + "</span> " + "<span style='color:#d2d2d2;display:none;'>" + json_user[i].time + "</span><span class='timeSpan' style='color:#ABABAB;margin-left:5px;'>&nbsp;</span>" : "<span style='color:#d2d2d2;display:none;'>" + json_user[i].time + "</span><span style='color:#ABABAB;margin-right:5px;'>&nbsp;</span><span style='color:" + color + "'>" + json_user[i].nickname + "</span>";
...
function fun_fromusermsg(json) {
    ...
    if (!dic_userlist[fu.id] && hex_md5($.cookie('user_id')) != fu.id) {
        ...
        var htmlstr = "<a id='userid_" + fu.id + "' class='list-group-item userList' style='color:black' onfocus='this.blur()' onclick='click_userlist(id);'>" +
                    "<img id='doheart_userid_" + fu.id + "' onclick='DoHeartUser(id);' alt='点击收藏' src='http://file1.nmcp.cn:668/img/sys/emptyheart.png' style='position: absolute;top: 2px;left: 0px;width: 20px;margin: 8px;z-index: 1;' />" +
                    "<span class='badge'></span><span style='margin-right:5px;position: absolute;top: 9px;left: 28px;' class='zql-bnt-user'></span>" +
...
function fun_msgrevoke(json) {
    ...
    var mess_id = json.user.content.replace('&nbsp;', ' ');
...
function fun_getUserOldMsgs(isFirst, firstTid) {
    ...
    // sendJson('getprivmsg', sel_userid, true);  
    // 用户历史消息获取
    var url = 'http://' + FilesCDN + ':668' + '/asmx/method.asmx/randomVIPGetHistoryUserMsgsPage';
    var method = 'post';
    var ifAsync = true;
    ...
    $.ajax(
    {
        ...
        success: function (data) {
            ...
            if (data.code == 0) {
                ...
                $("#old_mes_get").remove();
                $("#div_privmsg").prepend('<div id = "old_mes_get" onclick = "get_Random_Old_MessgePage();" style="width:200px;text-align:center;margin:10px auto;color:#09c;cursor: pointer;"><img alt="查看历史消息" src="http://file1.nmcp.cn:668/img/sys/time_pic.png" width="20" style="position: relative;top:-1px;" />查看历史消息</div>');
...
function fun_chatbox(json_user, code) {
    ...
    switch (code) {
        ...
        default:
            ...
            var color = cur_rauthor == id && code != 8 && code != 7 ? "orange" : "#ABABAB"
            var chattitle = !self ? "<span style='color:" + color + "'>" + json_user.nickname + "</span> " + "<span style='color:#d2d2d2;display:none;'>" + json_user.time + "</span><span class='timeSpan' style='color:#ABABAB;margin-left:5px;'>&nbsp;</span>" : "<span style='color:#d2d2d2;display:none;'>" + json_user.time + "</span><span style='color:#ABABAB;margin-right:5px;'>&nbsp;</span><span style='color:" + color + "'>" + json_user.nickname + "</span>";
            htmlstr = "<div class='chatbox' style='" + (self ? "float:right" : "float:left") + "' >"
                + "<div style='text-align:" + (self ? "right" : "left") + "'>" + chattitle + "</div>" +
...
function fun_getuploadimg() {
    $.getJSON("http://" + FilesCDN + ":668/asmx/upload.asmx/ProcessRequest", { act: "getUploadImg" }, function (json) {
        if (json.code != -1)
            uploadPic = json.msg;
    });
}
        ...
        for (var i = 0; i < em.length; i++) {
            if (em[i].indexOf('.') != -1) {
                if (em[i].indexOf('.wav') != -1) {
                    ...
                    if (wav)
                        str = str.replace(em[i], '<audio controls="controls"><source src="http://' + FilesCDN + ':668/Voice/' + $.trim(wav) + '"></audio>');
                }
                else if (em[i].indexOf('.rar') != -1 || em[i].indexOf('.zip') != -1) {
                    rar = em[i].replace("[", "").replace("]", "");
                    if (rar) {
                        var rar_param = rar.split('|');
                        str = str.replace(em[i], '<a href="http://' + FilesCDN + ':668/Files/' + rar_param[2] + '" target="_blank">' +
...
function imgupload_base64(base64str) {
    ...
    var upUrl;
    if (sel_userid == "") {
        upUrl = 'http://' + FilesCDN + ':668/asmx/upload.asmx/ProcessRequest?act=uploadPhotoRandoms';
    }
    else {
        upUrl = 'http://' + FilesCDN + ':668/asmx/upload.asmx/ProcessRequest?act=uploadPhotoRandom';
    }
...
function uploadfile(file) {
    ...
    var upUrl;
    if (sel_userid == "") {
        upUrl = 'http://' + FilesCDN + ':668/asmx/upload.asmx/ProcessRequest?act=uploadfileRandoms';
    }
    else {
        upUrl = 'http://' + FilesCDN + ':668/asmx/upload.asmx/ProcessRequest?act=uploadfileRandom';
    }
...
function upload(fileList) {
    for (var i = 0, l = fileList.length; i < l; i++) {
        ...
        var upUrl;
        if (sel_userid == "") {
            upUrl = 'http://' + FilesCDN + ':' + FileProt + '/asmx/upload.asmx/ProcessRequest?act=uploadImgRandom';
        }
        else {
            upUrl = 'http://' + FilesCDN + ':' + FileProt + '/asmx/upload.asmx/ProcessRequest?act=' + UpImg + '&userid=' + $.cookie('user_id');
        }
...
function XR() {
    ...
    //window.location.href = "https://bbs.nmcp.cn";
    ...
    //    area: ['350px', '512px'],
    //    //content: ['/list/70', 'no'], // 去掉滚动条
    //    content: 'https://bbs.nmcp.cn/list/70'
    //});
